...
<div class='crm-support'>
  ...
  <!-- LTS section -->
      <div class="crm-download-title">CiviCRM 4.4.9 LTS</div>
  <div class="crm-support">
    <div class="crm-introduction">
          The current Long Term Support (LTS) release CiviCRM is 4.4.9. Select a download based on the content management software (CMS) you are using.
    </div>
    <div class="crm-download-listing">
    <?php foreach ($content['download_urls'] as $key => $values) { ?>
      <div class="crm-download-buttons">
